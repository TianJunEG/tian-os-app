...
import { selectNextAlgebraPracticeTarget } from './AlgebraPracticeEngine.js';

// Pure view-model for the student Algebra learning-path screen.
...
const skills = algebraSkillGraph.skills;
...
export function buildAlgebraLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextAlgebraPracticeTarget({
...
export default { buildAlgebraLearningPathView };
