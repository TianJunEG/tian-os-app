...
import { selectNextCirclesPracticeTarget } from './CirclesPracticeEngine.js';

// Pure view-model for the student Circles learning-path screen.
...
const skills = circlesSkillGraph.skills;
...
export function buildCirclesLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextCirclesPracticeTarget({
...
export default { buildCirclesLearningPathView };
