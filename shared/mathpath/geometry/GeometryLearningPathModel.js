...
import { selectNextGeometryPracticeTarget } from './GeometryPracticeEngine.js';

// Pure view-model for the student Geometry learning-path screen.
...
const skills = geometrySkillGraph.skills;
...
export function buildGeometryLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextGeometryPracticeTarget({
...
export default { buildGeometryLearningPathView };
