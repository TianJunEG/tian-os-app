...
import { selectNextDecimalPracticeTarget } from './decimalsPracticeEngine.js';

// Pure view-model for the student Decimals learning-path screen. Keeps all the
...
const skills = decimalsSkillGraph.skills;
...
// masteryRecords: [{ skillId, status }] — skillId is a D-code (D001…D014).
export function buildDecimalsLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextDecimalPracticeTarget({
...
export default buildDecimalsLearningPathView;
