...
import { selectNextVolumePracticeTarget } from './VolumePracticeEngine.js';

// Pure view-model for the student Volume & Capacity learning-path screen.
...
const skills = volumeSkillGraph.skills;
...
export function buildVolumeLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextVolumePracticeTarget({
...
export default { buildVolumeLearningPathView };
