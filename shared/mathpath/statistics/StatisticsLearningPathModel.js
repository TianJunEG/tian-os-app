...
import { selectNextStatisticsPracticeTarget } from './StatisticsPracticeEngine.js';

// Pure view-model for the student Statistics learning-path screen.
...
const skills = statisticsSkillGraph.skills;
...
export function buildStatisticsLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextStatisticsPracticeTarget({
...
export default { buildStatisticsLearningPathView };
