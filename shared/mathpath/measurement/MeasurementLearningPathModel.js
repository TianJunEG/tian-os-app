...
import { selectNextMeasurementPracticeTarget } from './MeasurementPracticeEngine.js';

// Pure view-model for the student Measurement learning-path screen.
...
const skills = measurementSkillGraph.skills;
...
export function buildMeasurementLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextMeasurementPracticeTarget({
...
export default { buildMeasurementLearningPathView };
