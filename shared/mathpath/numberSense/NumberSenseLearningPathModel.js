...
import { selectNextNumberSensePracticeTarget } from './NumberSensePracticeEngine.js';

// Pure view-model for the student Number Sense learning-path screen.
...
const skills = numberSenseSkillGraph.skills;
...
export function buildNumberSenseLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextNumberSensePracticeTarget({
...
export default { buildNumberSenseLearningPathView };
