...
import { selectNextTimePracticeTarget } from './TimePracticeEngine.js';

// Pure view-model for the student Time learning-path screen.
...
const skills = timeSkillGraph.skills;
...
export function buildTimeLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextTimePracticeTarget({
...
export default { buildTimeLearningPathView };
