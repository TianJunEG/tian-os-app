...
import { selectNextMoneyPracticeTarget } from './MoneyPracticeEngine.js';

// Pure view-model for the student Money learning-path screen.
...
const skills = moneySkillGraph.skills;
...
export function buildMoneyLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextMoneyPracticeTarget({
...
export default { buildMoneyLearningPathView };
