...
import { selectNextAreaPerimeterPracticeTarget } from './AreaPerimeterPracticeEngine.js';

// Pure view-model for the student Area & Perimeter learning-path screen.
...
const skills = areaPerimeterSkillGraph.skills;
...
export function buildAreaPerimeterLearningPathView({ masteryRecords = [] } = {}) {
  ...
  const recommended = selectNextAreaPerimeterPracticeTarget({
...
export default { buildAreaPerimeterLearningPathView };
