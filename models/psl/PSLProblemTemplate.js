...
structure: { type: String, enum: ['partWhole', 'comparison', 'twoStep', 'beforeAfter', 'workBackwards', 'multiStep', 'guessCheck', 'ratio', 'dataInterpretation', 'excessShortage', 'comparisonMultiples', 'substitution', 'simultaneousChange', 'simultaneous', 'patternRecognition'], required: true },
