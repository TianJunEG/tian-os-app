...
const mathPathWorkingIntelligenceSchema = new mongoose.Schema(
  {
    ...
    reasoningAnalysis: { type: mongoose.Schema.Types.Mixed, default: null },
    reasoningRubric: { type: mongoose.Schema.Types.Mixed, default: null },
    representationAnalysis: { type: mongoose.Schema.Types.Mixed, default: null },
    strategyAnalysis: { type: mongoose.Schema.Types.Mixed, default: null },
    logicalFlowAnalysis: { type: mongoose.Schema.Types.Mixed, default: null },
    partialCreditRecommendation: { type: mongoose.Schema.Types.Mixed, default: null },
    methodMarkV3: { type: mongoose.Schema.Types.Mixed, default: null },
    wordProblemReasoning: { type: mongoose.Schema.Types.Mixed, default: null },
    multiStepSolutionMap: { type: mongoose.Schema.Types.Mixed, default: null },
    explanationAnalysis: { type: mongoose.Schema.Types.Mixed, default: null },
    studentReasoningFeedback: { type: String, default: '' },
    parentReasoningInsight: { type: mongoose.Schema.Types.Mixed, default: null },
    tutorReasoningInsight: { type: mongoose.Schema.Types.Mixed, default: null },
    teacherReasoningInsight: { type: mongoose.Schema.Types.Mixed, default: null },
    reasoningProgression: { type: mongoose.Schema.Types.Mixed, default: null },
    examReadinessIndicators: { type: mongoose.Schema.Types.Mixed, default: null },
