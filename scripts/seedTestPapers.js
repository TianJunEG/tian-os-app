...
const P4_MOCK_A = {
  ...
  questions: [
    ...
    { order: 24, section: 'B', paper: 1, marks: 2, type: 'shade_grid', stem: 'Shade 2 more squares so that the figure is symmetric about the dashed line.', grid: { rows: 4, cols: 4, preShaded: [[0, 1], [0, 2], [1, 0], [2, 1]], line: 'vertical' }, answer: '1-3,2-2', skillName: 'Symmetry' },
    { order: 25, section: 'B', paper: 1, marks: 2, type: 'short_answer', stem: 'Measure the marked angle x.', diagram: { kind: 'angle', degrees: 50, showValue: false, label: 'x' }, answer: '50', unit: '°', tolerance: 2, skillName: 'Measuring angles' },
