...
const TEMPLATES = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    contexts: [
      { entityA: 'stickers', setting: 'classroom' },
      { entityA: 'marbles', setting: 'playground' },
    ],
    constraints: {
      _generic: { diff: { min: 2, max: 20 }, smaller: { min: 5, max: 40 } },
      _computeStr: { larger: 'smaller + diff', total: 'larger + smaller', answer: 'larger' },
    },
  ...
  },
  {
    ...
    operations: ['addition', 'division'], difficulty: 2,
    contexts: [
      { entityA: 'books', setting: 'library' },
      { entityA: 'erasers', setting: 'bookshop' },
    ],
    constraints: {
      _generic: { diff: { min: 2, max: 20 }, smaller: { min: 5, max: 40 } },
      _computeStr: { larger: 'smaller + diff', total: 'larger + smaller', answer: 'larger' },
  ...
  },
  {
    ...
    contexts: [
      { entityA: 'points', setting: 'quiz competition' },
      { entityA: 'stamps', setting: 'stamp collection fair' },
    ],
    constraints: {
      _generic: { diff: { min: 2, max: 20 }, smaller: { min: 5, max: 40 } },
      _computeStr: { larger: 'smaller + diff', total: 'larger + smaller', answer: 'smaller' },
    },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    constraints: {
      _generic: { valA: { min: 3, max: 8 }, valB: { min: 5, max: 12 }, countA: { min: 2, max: 6 }, countB: { min: 2, max: 6 } },
      _computeStr: { valC: 'valA * countA + valB * countB', answer: 'countA' },
    },
    storyTemplate: '{nameA} {verb} some {entityA} at ${valA} each and some {entityB} at ${valB} each from {setting}. {nameA} paid ${valC} in total. How many {entityA} did {nameA} buy?',
    scaffold: gcScaffold(
      ...
      ['How many {entityA} {nameA} bought', 'The total cost of {entityA}', 'The change {nameA} received', 'Which item costs more'],
      ['{valA}', '{valB}', '{valC}'],
      [
  ...
  },
  {
    ...
    constraints: {
      _generic: { valA: { min: 3, max: 8 }, valB: { min: 5, max: 12 }, answer: { min: 2, max: 8 } },
      _computeStr: { valC: '(valA + valB) * answer' },
    },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    contexts: [
      { coinA: '20-cent', coinB: '50-cent' },
      { coinA: '20-cent', coinB: '50-cent' },
    ],
    constraints: {
      _generic: { countA: { min: 3, max: 12 }, countB: { min: 3, max: 10 } },
      _computeStr: { totalCoins: 'countA + countB', totalValue: 'countA * 20 + countB * 50', valCoinA: '20', valCoinB: '50', answer: 'countA' },
    },
    storyTemplate: '{nameA} has {totalCoins} coins made up of {coinA} and {coinB} coins. The total value of the coins is {totalValue} cents. How many {coinA} coins does {nameA} have?',
    scaffold: gcScaffold(
  ...
  },
  {
    ...
    operations: ['multiplication', 'addition'], difficulty: 3,
    contexts: [
      { coinA: '50-cent', coinB: '$1' },
      { coinA: '50-cent', coinB: '$1' },
    ],
    constraints: {
      _generic: { countA: { min: 3, max: 10 }, countB: { min: 3, max: 10 } },
      _computeStr: { totalCoins: 'countA + countB', totalValue: 'countA * 50 + countB * 100', valCoinA: '50', valCoinB: '100', answer: 'countB' },
    },
    storyTemplate: '{nameA} saved {totalCoins} coins in a piggy bank. The coins are a mix of {coinA} and {coinB} coins. The total amount saved is {totalValue} cents. How many {coinB} coins are there?',
    scaffold: gcScaffold(
  ...
  },
  {
    ...
    operations: ['multiplication', 'addition'], difficulty: 3,
    contexts: [
      { coinA: '10-cent', coinB: '20-cent' },
      { coinA: '10-cent', coinB: '20-cent' },
    ],
    constraints: {
      _generic: { countA: { min: 4, max: 15 }, countB: { min: 4, max: 12 } },
      _computeStr: { totalCoins: 'countA + countB', totalValue: 'countA * 10 + countB * 20', valCoinA: '10', valCoinB: '20', answer: 'countB' },
    },
    storyTemplate: 'A vending machine at {nameA}\'s school accepted only {coinA} and {coinB} coins. {nameA} inserted {totalCoins} coins worth {totalValue} cents in total. How many {coinB} coins did {nameA} use?',
    scaffold: gcScaffold(
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    constraints: {
      _generic: { younger: { min: 5, max: 15 }, ageDiff: { min: 20, max: 35 } },
      _computeStr: { older: 'younger + ageDiff', totalAge: 'younger + older', answer: 'younger' },
    },
  ...
  },
  {
    ...
    constraints: {
      _generic: { younger: { min: 5, max: 20 }, multiplier: { min: 2, max: 5 } },
      _computeStr: { older: 'younger * multiplier', ageDiff: 'older - younger', answer: 'younger' },
      _integerKeys: ['younger'],
    },
  ...
  },
  {
    ...
    constraints: {
      _generic: { younger: { min: 5, max: 12 }, ageDiff: { min: 2, max: 8 } },
      _computeStr: { older: 'younger + ageDiff', totalAge: 'younger + older', answer: 'younger' },
    },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    contexts: [
      { entityA: 'tables', entityB: 'chairs', setting: 'community centre' },
      { entityA: 'round tables', entityB: 'rectangular tables', setting: 'wedding banquet' },
    ],
    constraints: {
      _generic: { countA: { min: 3, max: 15 }, countB: { min: 3, max: 15 }, seatsA: { min: 4, max: 4 }, seatsB: { min: 6, max: 6 } },
      _computeStr: { totalFurniture: 'countA + countB', totalSeats: 'countA * seatsA + countB * seatsB', answer: 'countA' },
    },
  ...
  },
  {
    ...
    operations: ['multiplication', 'addition'], difficulty: 4,
    contexts: [
      { entityA: 'bicycles', entityB: 'tricycles', setting: 'East Coast Park' },
      { entityA: 'cars', entityB: 'motorcycles', setting: 'HDB carpark' },
    ],
    constraints: {
      _generic: { countA: { min: 3, max: 15 }, countB: { min: 3, max: 15 }, wheelsA: { min: 2, max: 2 }, wheelsB: { min: 3, max: 3 } },
      _computeStr: { totalVehicles: 'countA + countB', totalWheels: 'countA * wheelsA + countB * wheelsB', answer: 'countA' },
    },
  ...
  },
  {
    ...
    operations: ['multiplication', 'addition'], difficulty: 4,
    contexts: [
      { entityA: '$5 notes', entityB: '$2 notes', setting: 'Lunar New Year' },
      { entityA: '$10 notes', entityB: '$5 notes', setting: 'Hari Raya' },
    ],
    constraints: {
      _generic: { countA: { min: 3, max: 10 }, countB: { min: 3, max: 10 }, valA: { min: 5, max: 5 }, valB: { min: 2, max: 2 } },
      _computeStr: { totalNotes: 'countA + countB', totalValue: 'countA * valA + countB * valB', answer: 'countA' },
    },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    constraints: {
      _generic: { perPersonA: { min: 3, max: 8 }, perPersonB: { min: 5, max: 12 }, excess: { min: 2, max: 10 }, shortage: { min: 2, max: 10 } },
      _computeStr: { diff: 'perPersonB - perPersonA', answer: '(excess + shortage) / diff' },
      _integerKeys: ['answer'],
    },
  ...
  },
  {
    ...
    constraints: {
      _generic: { perPersonA: { min: 2, max: 6 }, perPersonB: { min: 4, max: 10 }, excess: { min: 3, max: 12 }, shortage: { min: 3, max: 12 } },
      _computeStr: { diff: 'perPersonB - perPersonA', answer: '(excess + shortage) / diff' },
      _integerKeys: ['answer'],
    },
  ...
  },
  {
    ...
    constraints: {
      _generic: { perPersonA: { min: 4, max: 9 }, perPersonB: { min: 6, max: 14 }, excess: { min: 5, max: 15 }, shortage: { min: 5, max: 15 } },
      _computeStr: { diff: 'perPersonB - perPersonA', answer: '(excess + shortage) / diff' },
      _integerKeys: ['answer'],
    },
