...
export default {
  ...
  skills: [
    ...
    { slug: 'rr.divide', name: 'Dividing a quantity in a given ratio', level: 'Primary 5',
      prerequisites: ['rr.equivalent', 'op.div.short'], masteryType: 'procedural', fluencyType: 'accuracy', heuristic: 'ratio',
      visualModels: ['bar'],
      misconceptions: [
    ...
    { slug: 'rr.divide-3', name: 'Dividing in a three-part ratio', level: 'Primary 6',
      prerequisites: ['rr.divide', 'rr.three-term'], masteryType: 'application', fluencyType: 'accuracy', heuristic: 'ratio',
      visualModels: ['bar'],
    ...
    { slug: 'rr.before-after', name: 'Ratio before and after a change', level: 'Primary 6',
      prerequisites: ['rr.divide'], masteryType: 'application', fluencyType: 'untimed-reasoning', heuristic: 'before-after',
      visualModels: ['bar'],
    ...
    { slug: 'rr.combine', name: 'Combining two ratios (a:b and b:c)', level: 'Primary 6',
      prerequisites: ['rr.equivalent'], masteryType: 'application', fluencyType: 'untimed-reasoning', heuristic: 'ratio',
      visualModels: ['ratio-table'],
    ...
    { slug: 'rr.rate-tiered', name: 'Tiered / compound rates (tariffs)', level: 'Primary 6',
      prerequisites: ['rr.rate'], masteryType: 'application', fluencyType: 'accuracy', heuristic: 'ratio',
      visualModels: ['bar'],
    ...
    { slug: 'rr.speed-avg', name: 'Average speed and relative motion', level: 'Primary 6',
      prerequisites: ['rr.speed'], masteryType: 'application', fluencyType: 'untimed-reasoning', heuristic: 'ratio',
      visualModels: ['double-number-line'],
    ...
    { slug: 'rr.proportion', name: 'Direct proportion foundations', level: 'Primary 6',
      prerequisites: ['rr.equivalent', 'rr.rate'], masteryType: 'application', fluencyType: 'untimed-reasoning', heuristic: 'ratio',
      visualModels: ['ratio-table', 'double-number-line'],
