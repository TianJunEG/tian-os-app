...
const animalsConstraints = (legsA, legsB) => ({
  ...
  _compute: {
    countA: 'totalItems - countB',
    totalValue: `(totalItems - countB) * ${legsA} + countB * ${legsB}`,
    assumedTotal: `totalItems * ${legsA}`,
    diff: `Math.abs(totalItems * ${legsA} - ((totalItems - countB) * ${legsA} + countB * ${legsB}))`,
...
const itemsConstraints = {
  ...
  _compute: {
    countA: 'totalItems - countB',
    totalCost: '(totalItems - countB) * priceA + countB * priceB',
    assumedTotal: 'totalItems * priceA',
    diff: 'Math.abs((totalItems - countB) * priceA + countB * priceB - totalItems * priceA)',
    swapDiff: 'priceB - priceA',
    answer: 'countB',
  },
  answer: { min: 3 },
};
...
const coinsConstraints = (valA, valB) => ({
  ...
  _compute: {
    countA: 'totalItems - countB',
    totalValue: `(totalItems - countB) * ${valA} + countB * ${valB}`,
    assumedTotal: `totalItems * ${valA}`,
    diff: `Math.abs((totalItems - countB) * ${valA} + countB * ${valB} - totalItems * ${valA})`,
...
const scoringConstraints = {
  ...
  _compute: {
    countA: 'totalItems - countB',
    totalValue: '(totalItems - countB) * markGain - countB * markLose',
    assumedTotal: 'totalItems * markGain',
    diff: 'Math.abs(totalItems * markGain - ((totalItems - countB) * markGain - countB * markLose))',
    swapDiff: 'markGain + markLose',
    answer: 'countB',
  },
  answer: { min: 3 },
};
...
const templates = [
  ...
  },
  {
    ...
    constraints: {
      ...
      _compute: {
        countA: 'totalItems - countB',
        totalValue: '(totalItems - countB) * capacityA + countB * capacityB',
        assumedTotal: 'totalItems * capacityA',
        diff: 'countB * capacityB + (totalItems - countB) * capacityA - totalItems * capacityA',
        swapDiff: 'capacityB - capacityA',
        answer: 'countB',
      },
      answer: { min: 3 },
    },
