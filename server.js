...
import mathpathAreaPerimeterRoutes from './routes/mathpathAreaPerimeter.js';
import mathpathCirclesRoutes from './routes/mathpathCircles.js';
import mathpathVolumeRoutes from './routes/mathpathVolume.js';
import mathpathStatisticsRoutes from './routes/mathpathStatistics.js';
import mathpathAlgebraRoutes from './routes/mathpathAlgebra.js';
...
app.use('/api/mathpath/percentages', mathpathPercentageRoutes);
app.use('/api/mathpath/ratio-rate', mathpathRatioRateRoutes);
...
app.use('/api/mathpath/area-perimeter', mathpathAreaPerimeterRoutes);
app.use('/api/mathpath/circles', mathpathCirclesRoutes);
app.use('/api/mathpath/volume', mathpathVolumeRoutes);
app.use('/api/mathpath/statistics', mathpathStatisticsRoutes);
app.use('/api/mathpath/algebra', mathpathAlgebraRoutes);
