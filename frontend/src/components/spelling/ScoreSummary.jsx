...
export default function ScoreSummary({ correct, total, onRestart, restartLabel = 'Try again', unit = 'correct' }) {
  ...
  return (
    <div className="text-center py-8">
      ...
      <div className="text-5xl font-extrabold text-emerald mb-1">{pct}%</div>
      ...
      <button
        onClick={onRestart}
        className="px-6 py-3 bg-emerald text-white rounded-lg hover:bg-emerald-deep font-medium inline-flex items-center gap-2"
      >
