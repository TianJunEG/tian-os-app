  ...
  return (
    <div>
      ...
      <textarea
        ...
        className="w-full p-3 border border-gray-300 rounded-lg focus:border-purple-500 outline-none text-sm"
      />
      ...
      <div className="flex flex-wrap items-center gap-3 my-4 text-sm">
        {!playing ? (
          <button
            ...
            className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:opacity-40 inline-flex items-center gap-2"
          >
      ...
      {report && (
        <div className="mt-6 p-4 bg-gray-50 rounded-xl">
          <div className="text-lg font-semibold text-gray-900 mb-2">
            Accuracy: <span className="text-purple-600">{report.accuracy}%</span>{' '}
