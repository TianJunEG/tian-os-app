    ...
    <div className="fixed inset-x-0 bottom-20 md:bottom-6 z-[60] px-3 flex flex-col items-center gap-2 pointer-events-none print:hidden">
      ...
      {waiting && (
        <div className="pointer-events-auto w-full max-w-sm flex items-center gap-3 px-4 py-3 rounded-lg bg-white border border-gray-200 shadow-lg">
          ...
          <button
            onClick={applyUpdate}
            className="px-3 py-1.5 text-sm font-medium text-white bg-emerald rounded-lg hover:bg-emerald-deep"
          >
            Reload
          </button>
        </div>
      ...
      {showInstall && (
        <div className="pointer-events-auto w-full max-w-sm flex items-center gap-3 px-4 py-3 rounded-lg bg-white border border-gray-200 shadow-lg">
          <Download className="w-5 h-5 text-emerald flex-shrink-0" />
          <span className="text-sm text-gray-700 flex-1">Install Tian OS for a faster, full-screen experience.</span>
          <button
            onClick={install}
            className="px-3 py-1.5 text-sm font-medium text-white bg-emerald rounded-lg hover:bg-emerald-deep"
          >
