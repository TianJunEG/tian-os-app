  ...
  return (
    <div className="lifelab-phone">
      ...
      <div className="lifelab-content">
        <div className="header">
          <div className="header-top">
            <div className="header-branding">
              <div className="header-label">Tian OS</div>
              <div className="header-title">LifeLab</div>
            </div>
        ...
        <div className="content-scroll" style={{ padding: '0 20px' }}>
          <div className="chips">
            {filters.map((filter) => (
              <button
                key={filter}
                className={`chip ${selectedFilter === filter ? 'active' : 'inactive'}`}
          ...
          {loading ? (
            ...
            <>
              {/* Featured activity */}
              {filteredTemplates.length > 0 && (
                <div className="card featured" style={{ cursor: 'pointer' }}>
              ...
              <div style={{ marginTop: 12 }}>
                {filteredTemplates.map((template) => (
                  <div key={template._id} className="card" onClick={() => onSelectTemplate(template)}>
                    <div className="card-header">
                      <div className={`activity-thumb ${getTone(template)}`}>
      ...
      <div className="bottom-nav">
        {[
          ...
          <button
            key={id}
            className={`bottom-nav-item ${id === 'library' ? 'active' : ''}`}
