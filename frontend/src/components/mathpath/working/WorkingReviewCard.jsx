            ...
            <div key={item.id} className="rounded-xl border border-line-soft p-3">
              <div className="flex items-start justify-between gap-2">
                ...
                <button
                  ...
                  className="rounded-md p-1 text-ink-400 hover:bg-surface-raised hover:text-ink-700"
              ...
              {!item.type?.startsWith('image/') && (
                <div className="mt-2 rounded-lg bg-surface-raised px-3 py-2 text-xs text-ink-600">PDF document</div>
              )}
              <div className="mt-2">
