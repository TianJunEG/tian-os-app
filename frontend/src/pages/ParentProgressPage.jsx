          ...
          <>
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-8">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center">
                <div>
                  <p className="text-xl sm:text-2xl font-bold text-green-600">{progress.masterCount}</p>
                  <p className="text-xs sm:text-sm text-gray-600">Mastered</p>
                </div>
                <div>
                  <p className="text-xl sm:text-2xl font-bold text-blue-600">{progress.okCount}</p>
                  <p className="text-xs sm:text-sm text-gray-600">On track</p>
                </div>
                <div>
                  <p className="text-xl sm:text-2xl font-bold text-red-600">{progress.strugglingCount}</p>
                  <p className="text-xs sm:text-sm text-gray-600">Struggling</p>
                </div>
              </div>
            </div>
