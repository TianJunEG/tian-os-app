...
// After a wrong (non-skipped) answer, Talia surfaces the misconception. Prefers a
// precise diagnosis from the student's actual answer, falling back to a
// skill-level hint; renders nothing when neither is available.
