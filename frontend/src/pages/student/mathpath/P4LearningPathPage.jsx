...
import p4WholeNumbersSkillGraph from '../../../mathpath/primary/p4WholeNumbersSkillGraph';
import p4FactorsMultiplesSkillGraph from '../../../mathpath/primary/p4FactorsMultiplesSkillGraph';
import p4FourOpsSkillGraph from '../../../mathpath/primary/p4FourOpsSkillGraph';
import p4FractionsSkillGraph from '../../../mathpath/primary/p4FractionsSkillGraph';
...
// Skill card
// ---------------------------------------------------------------------------
function P4SkillCard({ skill, onStart, skillState }) {
  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        {skills.map((skill) => (
          <P4SkillCard key={skill.id} skill={skill} onStart={onSkillStart} skillState={skillStatesMap[skill.id]} />
        ))}
      </div>
    </section>
  );
...
// Page component
// ---------------------------------------------------------------------------
export default function P4LearningPathPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const { data } = await mathpathAPI.getP4SkillStates();
        if (cancelled) return;
        const map = {};
        ...
        console.warn('[P4LearningPath] Could not load skill states:', err.message);
      }
    })();
  ...
  const handleSkillStart = (skill) => {
    navigate(`/student/mathpath/practice/skill-${skill.id}`, {
      state: {
        ...
        source: 'p4-learning-path',
        backTo: '/student/mathpath/p4',
        homeBase: '/student/mathpath/p4',
      },
    });
  };
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <PageHeader
        ...
        subtitle={totalMastered > 0
          ...
          : `${totalSkills} skills across 7 domains — Singapore MOE P4 syllabus.`}
      />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:items-end">
            <Button
              icon={ArrowRight}
              onClick={() => {
                navigate('/student/mathpath/practice/skill-P4-WN-01', {
                  state: {
                    skillId: 'P4-WN-01',
                    questionCount: 6,
                    sessionType: 'practice',
                    source: 'p4-learning-path-hero',
                    backTo: '/student/mathpath/p4',
                    homeBase: '/student/mathpath/p4',
                  },
                });
            ...
            <Button
              variant="secondary"
              onClick={() => {
                navigate('/student/mathpath/practice/skill-P4-DIAGNOSTIC', {
                  state: {
                    skillId: 'P4-DIAGNOSTIC',
                    sessionType: 'diagnostic',
                    source: 'p4-learning-path-diagnostic',
                    backTo: '/student/mathpath/p4',
                    homeBase: '/student/mathpath/p4',
                  },
                });
