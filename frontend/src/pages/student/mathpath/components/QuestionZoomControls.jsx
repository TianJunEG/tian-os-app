  ...
  return (
    <div className="inline-flex items-center gap-1 rounded-lg border border-line-soft bg-white px-1 py-1 shadow-sm" aria-label="Question zoom controls">
      <button
        ...
        className="grid h-8 w-8 place-items-center rounded-md text-ink-600 transition hover:bg-surface-raised hover:text-emerald-deep disabled:cursor-not-allowed disabled:opacity-40"
      >
