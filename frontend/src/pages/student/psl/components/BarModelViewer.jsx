      ...
      <div className="space-y-2 rounded-xl border border-ink-200 bg-surface-white p-3 sm:p-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <div
              className="flex items-center justify-center rounded-lg bg-sky-100 px-2 sm:px-3 py-2 text-xs sm:text-sm font-bold text-sky-700"
              style={{ width: `${smallerWidth}%`, minHeight: 36 }}
            >
              {unknownPosition === 'smaller' ? '?' : smaller}
            </div>
            <div className="flex items-center justify-center rounded-lg border-2 border-dashed border-amber-300 bg-amber-50 px-2 py-2 text-xs sm:text-sm font-bold text-amber-600 shrink-0"
              style={{ minHeight: 36 }}
            >
