          ...
          <div className="flex items-stretch gap-2">
            <div className="flex-1 rounded-xl border-2 border-gold-300 bg-gold-50/50 p-3">
              ...
              <input
                ...
                className="mt-1 w-full border-none bg-transparent font-mono text-lg font-bold text-ink-800 outline-none placeholder:text-ink-300"
              />
            </div>
          </div>
          <div className="flex items-stretch gap-2">
            ...
            <div className="flex items-center rounded-xl border-2 border-dashed border-amber-300 bg-amber-50/50 px-3">
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          {parts.map((part, i) => (
            <div key={i} className="flex-1 rounded-xl border-2 border-ink-200 bg-white p-3">
              <input
                type="text"
