const SCRIPTS = {
  ...
  'assumption': {
    steps: [
      "Let's assume all items are one type and see what total we get.",
      "Compare the assumed total with the actual total — find the difference.",
      "Each swap changes the total by a fixed amount. Divide to find how many swaps.",
    ],
    answer: "Check — do both item counts add up to the total?",
  },
  'data-interpretation': {
    steps: [
      "Let's read the chart or table carefully — what does each part show?",
      "Pick out the numbers we need for the question.",
      "Now calculate using those values.",
    ],
    answer: "Does the answer match what the data shows?",
  },
  'pattern-recognition': {
    steps: [
