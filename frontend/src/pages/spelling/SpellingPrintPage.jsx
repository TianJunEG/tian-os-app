  ...
  const Cell = ({ ch, highlighted }) => (
    <span
      className={`ws-cell inline-flex items-center justify-center border border-gray-300 font-mono uppercase ${
        highlighted ? 'font-bold text-purple-700 print:text-black' : 'text-gray-800'
      }`}
    ...
    <div className="min-h-screen bg-gray-100 print:bg-white">
      ...
      <div className="print:hidden bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-3 flex flex-wrap items-center gap-3">
          <button onClick={() => navigate(`/spelling/lists/${id}`)} className="text-sm text-gray-500 hover:text-purple-600 inline-flex items-center gap-1">
            ...
            {types.map((t) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-md text-sm font-medium inline-flex items-center gap-1.5 ${
                  type === t.key ? 'bg-white text-purple-700 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                }`}
              >
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            ...
            {type === 'wordsearch' && (
              <>
                ...
                <button onClick={() => setRegen((n) => n + 1)} className="text-purple-600 hover:underline">
                  Shuffle
                </button>
              </>
            )}
          ...
          <button
            ...
            className="ml-auto px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-medium inline-flex items-center gap-2"
          >
