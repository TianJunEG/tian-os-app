...
const familiesBySkillBlueprint = {
  ...
  F015: [
    { name: 'Mixed to Improper Conversion', description: 'Convert mixed numbers to improper fractions.', difficulty: 3, fluencyTargetSeconds: 16, mentalMathEligible: true, misconceptionTags: ['M006', 'M010'] },
    { name: 'Improper to Mixed Conversion', description: 'Convert improper fractions to mixed numbers.', difficulty: 3, fluencyTargetSeconds: 18, mentalMathEligible: true, misconceptionTags: ['M006', 'M005'] },
    { name: 'Bidirectional Conversion in Context', description: 'Choose and convert in applied settings.', difficulty: 4, fluencyTargetSeconds: 24, misconceptionTags: ['M006', 'M010'] },
    { name: 'Add Like Fractions Core Fluency', description: 'Add like-denominator fractions without changing denominator.', difficulty: 2, fluencyTargetSeconds: 14, mentalMathEligible: true, misconceptionTags: ['M007', 'M005'] },
    { name: 'Add Like Fractions Simplify Final Answer', description: 'Add like fractions then simplify where needed.', difficulty: 3, fluencyTargetSeconds: 18, misconceptionTags: ['M007', 'M005', 'M010'] },
  ],
  F016: [
