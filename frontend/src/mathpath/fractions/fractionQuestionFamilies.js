...
const familiesBySkillBlueprint = {
  F001: [
    { name: 'Identify Fractional Parts from Shapes', description: 'Recognise whether shaded parts represent fractions.', difficulty: 1, fluencyTargetSeconds: 18, workingRequired: false, mentalMathEligible: true, misconceptionTags: ['M003'] },
    { name: 'Count Equal Parts in a Whole', description: 'Determine denominator from equal-part partitions.', difficulty: 1, fluencyTargetSeconds: 20, workingRequired: false, mentalMathEligible: true, misconceptionTags: ['M003'] },
    { name: 'Reject Non-Fraction Partitions', description: 'Distinguish equal vs unequal partitions.', difficulty: 2, fluencyTargetSeconds: 22, workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M003'] },
  ],
  F002: [
    { name: 'Name Numerator and Denominator', description: 'Label top and bottom numbers correctly.', difficulty: 1, fluencyTargetSeconds: 16, workingRequired: false, mentalMathEligible: true, misconceptionTags: ['M003'] },
    { name: 'Interpret Numerator Meaning', description: 'Read numerator as selected/equal parts.', difficulty: 2, fluencyTargetSeconds: 18, workingRequired: false, mentalMathEligible: true, misconceptionTags: ['M003'] },
    { name: 'Interpret Denominator Meaning', description: 'Read denominator as total equal parts.', difficulty: 2, fluencyTargetSeconds: 18, workingRequired: false, mentalMathEligible: true, misconceptionTags: ['M003'] },
  ],
  F003: [
  ...
  F011: [
    { name: 'Generate Equivalents by Multiplication', description: 'Scale numerator and denominator by same factor.', difficulty: 2, fluencyTargetSeconds: 16, mentalMathEligible: true, misconceptionTags: ['M004'] },
    { name: 'Generate Missing Terms in Equivalents', description: 'Fill blanks in equivalent-fraction equations.', difficulty: 3, fluencyTargetSeconds: 18, misconceptionTags: ['M004'] },
    { name: 'Generate Multi-Step Equivalent Chains', description: 'Create multiple equivalent forms progressively.', difficulty: 3, fluencyTargetSeconds: 22, misconceptionTags: ['M004'] },
  ],
  F012: [
    { name: 'Simplify with Common Factors', description: 'Reduce fractions using known common factors.', difficulty: 2, fluencyTargetSeconds: 16, mentalMathEligible: true, misconceptionTags: ['M005'] },
    { name: 'Simplify to Lowest Terms', description: 'Ensure final fraction is fully simplified.', difficulty: 3, fluencyTargetSeconds: 18, misconceptionTags: ['M005'] },
    { name: 'Simplify After Intermediate Steps', description: 'Simplify in multi-step symbolic expressions.', difficulty: 4, fluencyTargetSeconds: 24, misconceptionTags: ['M005'] },
  ],
  F013: [
    ...
    { name: 'Represent Improper Fractions Visually', description: 'Show improper fractions with whole+part visuals.', difficulty: 3, fluencyTargetSeconds: 20, misconceptionTags: ['M006'] },
    { name: 'Interpret Values Greater than One', description: 'Interpret improper values in context.', difficulty: 3, fluencyTargetSeconds: 22, misconceptionTags: ['M006'] },
  ],
  F014: [
    { name: 'Read Mixed Numbers', description: 'Interpret whole number and fractional part.', difficulty: 2, fluencyTargetSeconds: 14, workingRequired: false, mentalMathEligible: true, misconceptionTags: ['M006'] },
    { name: 'Represent Mixed Numbers', description: 'Build mixed numbers from visual and symbolic forms.', difficulty: 3, fluencyTargetSeconds: 18, misconceptionTags: ['M006'] },
    { name: 'Compare Mixed Numbers', description: 'Compare mixed numbers in ordered sets.', difficulty: 3, fluencyTargetSeconds: 22, misconceptionTags: ['M006'] },
  ],
  F015: [
    { name: 'Mixed to Improper Conversion', description: 'Convert mixed numbers to improper fractions.', difficulty: 3, fluencyTargetSeconds: 16, mentalMathEligible: true, misconceptionTags: ['M006'] },
    { name: 'Improper to Mixed Conversion', description: 'Convert improper fractions to mixed numbers.', difficulty: 3, fluencyTargetSeconds: 18, mentalMathEligible: true, misconceptionTags: ['M006'] },
    { name: 'Bidirectional Conversion in Context', description: 'Choose and convert in applied settings.', difficulty: 4, fluencyTargetSeconds: 24, misconceptionTags: ['M006'] },
  ],
  F016: [
