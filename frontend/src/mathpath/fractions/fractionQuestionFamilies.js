...
function buildFamily(skillId, index, config) {
  return {
    ...
    generatorKind: config.generatorKind || null,
...
const familiesBySkillBlueprint = {
  ...
  F003: [
    ...
    { name: 'Equivalent Visual Representations', description: 'Match same fraction across different visual forms.', difficulty: 2, fluencyTargetSeconds: 22, generatorKind: 'fractionFromModel', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M004'] },
  ],
  F004: [
    ...
    { name: 'Represent Unit Fractions', description: 'Represent 1/n on simple shapes and bars.', difficulty: 2, fluencyTargetSeconds: 18, generatorKind: 'unitFractionId', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M003'] },
  ...
  F005: [
    ...
    { name: 'Compare Positions on Number Lines', description: 'Use number-line positions to compare values.', difficulty: 3, fluencyTargetSeconds: 22, generatorKind: 'fractionOrder', misconceptionTags: ['M001'] },
    ...
    { name: 'Number Line Reading with Operation', description: 'Read fractions from two number lines and compute their sum or difference.', difficulty: 4, fluencyTargetSeconds: 30, generatorKind: 'numberLineOp', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M003', 'M007'] },
  ],
  F006: [
  ...
  F007: [
    ...
    { name: 'Equivalent Context Checks', description: 'Verify comparisons using equivalent forms.', difficulty: 3, fluencyTargetSeconds: 18, generatorKind: 'fractionEquiv', misconceptionTags: ['M004'] },
  ],
  F008: [
    ...
    { name: 'Order Same-Numerator Sets', description: 'Sort fractions sharing common numerator.', difficulty: 2, fluencyTargetSeconds: 16, generatorKind: 'fractionOrder', mentalMathEligible: true, misconceptionTags: ['M002'] },
    { name: 'Mixed Representation Comparison', description: 'Compare with visuals and symbolic fractions.', difficulty: 3, fluencyTargetSeconds: 20, generatorKind: 'visualFractionCompare', misconceptionTags: ['M002'] },
  ],
  F009: [
    { name: 'Order Fractions with Same Denominator', description: 'Quick ordering where denominator is fixed.', difficulty: 2, fluencyTargetSeconds: 16, generatorKind: 'fractionOrder', mentalMathEligible: true, misconceptionTags: ['M003'] },
    ...
    { name: 'Evaluate Multiple Comparison Statements', description: 'Decide whether each of several fraction comparison statements is true or false.', difficulty: 3, fluencyTargetSeconds: 26, generatorKind: 'compareStatements', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M004', 'M002'] },
  ],
  F010: [
  ...
  F011: [
    ...
    { name: 'Generate Multi-Step Equivalent Chains', description: 'Create multiple equivalent forms progressively.', difficulty: 3, fluencyTargetSeconds: 22, generatorKind: 'equivChain', misconceptionTags: ['M004', 'M010'] },
    { name: 'Two-Unknown Equivalent Fraction Chain', description: 'Find two missing values in a chain like A/4 = 6/8 = 9/B using cross-multiplication.', difficulty: 4, fluencyTargetSeconds: 28, generatorKind: 'equivChain', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M004', 'M005', 'M010'] },
    ...
    { name: 'Visual Same-Denominator Comparison Checks', description: 'Match same-denominator symbolic comparison with model evidence.', difficulty: 3, fluencyTargetSeconds: 20, generatorKind: 'visualDenomCompare', misconceptionTags: ['M003', 'M010'] },
  ],
  F012: [
    ...
    { name: 'Simplify After Intermediate Steps', description: 'Simplify in multi-step symbolic expressions.', difficulty: 4, fluencyTargetSeconds: 24, generatorKind: 'simplifyAfterOp', misconceptionTags: ['M005', 'M010'] },
    ...
    { name: 'Same Numerator Visual Mismatch Checks', description: 'Identify when visual model disagrees with symbolic comparison.', difficulty: 3, fluencyTargetSeconds: 20, generatorKind: 'visualNumerCompare', misconceptionTags: ['M002', 'M010'] },
  ],
  F013: [
  ...
  F015: [
    ...
    { name: 'Place Mixed and Improper on Number Lines', description: 'Locate mixed numbers and improper fractions on number lines beyond one whole.', difficulty: 4, fluencyTargetSeconds: 26, generatorKind: 'numberLineMixed', misconceptionTags: ['number_line_partition_error', 'mixed_number_conversion_error'] },
  ],
  F016: [
    ...
    { name: 'Find Missing Addend in Fraction Equation', description: 'Determine the missing fraction in equations like ? + 1/2 = 3/4 or 6/10 + ? = 1.', difficulty: 3, fluencyTargetSeconds: 22, generatorKind: 'fractionMissingTerm', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M007', 'M004'] },
  ],
  F017: [
    ...
    { name: 'Subtract Like Fractions in Context', description: 'Apply subtraction in one-step context items.', difficulty: 3, fluencyTargetSeconds: 20, generatorKind: 'fractionLike', misconceptionTags: ['M007'] },
  ...
  F019: [
    ...
    { name: 'Find Missing Subtrahend in Fraction Equation', description: 'Determine the missing fraction in equations like 11/12 - ?/3 = 1/4.', difficulty: 4, fluencyTargetSeconds: 28, generatorKind: 'fractionMissingTerm', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M007', 'M004'] },
  ],
  F020: [
    ...
    { name: 'Fraction of Quantity (Multiples)', description: 'Solve quantities that divide cleanly.', difficulty: 3, fluencyTargetSeconds: 20, generatorKind: 'fractionOfWhole', mentalMathEligible: true, misconceptionTags: ['M008'] },
    ...
    { name: 'Fraction of Quantity Word Problems', description: 'Apply fraction-of-quantity to realistic contexts.', difficulty: 4, fluencyTargetSeconds: 34, generatorKind: 'fractionOfWhole', misconceptionTags: ['M008'] },
    { name: 'Fraction of Quantity Multi-Step Applications', description: 'Solve exam-style multi-step quantity scenarios.', difficulty: 5, fluencyTargetSeconds: 42, generatorKind: 'multiStepQuantity', misconceptionTags: ['M008', 'M010'] },
    { name: 'Shade Additional Parts to Reach Target Fraction', description: 'Given a partially shaded figure, determine how many more parts to shade so the figure shows a target fraction.', difficulty: 3, fluencyTargetSeconds: 26, generatorKind: 'shadeToTarget', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M003', 'M008'] },
  ],
  F021: [
  ...
  F022: [
    ...
    { name: 'Division with Simplification and Conversion', description: 'Divide and simplify/convert final answers.', difficulty: 5, fluencyTargetSeconds: 32, generatorKind: 'divByFraction', misconceptionTags: ['M009', 'M005', 'M006'] },
  ...
  F023: [
    ...
    { name: 'Set-Based Fraction Counting', description: 'Find fractional parts of object sets using count-based reasoning.', difficulty: 3, fluencyTargetSeconds: 24, generatorKind: 'fractionOfSet', misconceptionTags: ['M003', 'M008'] },
    { name: 'Fraction Remainder After Multiple Events', description: 'Find the fraction remaining after two or more fractional parts are removed from a whole.', difficulty: 4, fluencyTargetSeconds: 32, generatorKind: 'fractionRemainderWP', workingRequired: true, mentalMathEligible: false, misconceptionTags: ['M008', 'M007'] },
  ],
  F024: [
