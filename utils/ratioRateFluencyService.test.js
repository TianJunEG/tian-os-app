...
describe('Ratio & Rate fluency — benchmarks + classification', () => {
...
describe('Ratio & Rate fluency — drill building', () => {
  ...
  it('strips answers from the client copy', () => {
    const drill = buildRatioRateFluencyDrill({ skillId: 'R003', count: 4 });
...
describe('Ratio & Rate fluency — scoring', () => {
